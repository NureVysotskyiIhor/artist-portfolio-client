...
import { homepageCreateSchema, type HomepageCreateFormInput } from '@/utils/validations-homepage/homepage-create.utils'
...
export const HomepageCreateForm = () => {
    ...
    const { register, handleSubmit, formState: { errors } } = useForm<HomepageCreateFormInput>({

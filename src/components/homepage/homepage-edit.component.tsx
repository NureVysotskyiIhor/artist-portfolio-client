...
import { homepageEditSchema, type HomepageEditFormInput } from '@/utils/validations-homepage/homepage-edit.utils'
...
export const HomepageEditForm = ({ profile }: HomepageEditProps ) => {
    ...
    const { register, handleSubmit, reset,  formState: { errors } } = useForm<HomepageEditFormInput>({
    ...
    <main className="max-w-2xl mx-auto px-4 py-10">
      <div className="mb-8">
        ...
        <p className="text-sm text-foreground/50">
          Update your public portfolio page
        </p>
      </div>
      ...
      <div className="bg-white rounded-3xl border-[1.5px] border-border p-8 shadow-sm">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              {...register('skills')}
              placeholder="Oil painting, Watercolor, Sculpture"
            />
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              placeholder="Exhibition 2023, Award winner"
            />
            <p className="text-xs text-muted-foreground">Separate with commas</p>
          </div>

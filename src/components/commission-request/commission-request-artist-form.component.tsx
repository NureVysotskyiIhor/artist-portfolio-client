...
} from '@/utils/validations-commission-request/commission-request-artist-update.utils';
...
export const CommissionRequestArtistForm = ({
  request,
  onClose,
}: CommissionRequestArtistFormProps) => {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<CommissionRequestArtistUpdateFormInput>({

      ...
      {overlay.type !== 'none' && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative z-10 w-full max-w-md mx-4 bg-white rounded-3xl border border-border p-8 shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            {overlay.type === 'edit' && <CommissionRequestUserForm request={overlay.request} onClose={handleClose} />}
            {overlay.type === 'delete' && <CommissionRequestDeleteDialog request={overlay.request} onClose={handleClose} />}
          </div>
        </div>
      )}
    </main>

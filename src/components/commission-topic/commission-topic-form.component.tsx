...
import { commissionTopicSchema, type CommissionTopicFormInput } from '@/utils/validations-commission-topic/commission-topic.utils'
import { useCreateCommissionTopicMutation, useUpdateCommissionTopicMutation } from '@/queries/commission-topic.queries'
...
export const CommissionTopicForm = ({ topic, onClose }: CommissionTopicFormProps)=> {
    ...
    const { register, handleSubmit, reset, formState: { errors } } = useForm<CommissionTopicFormInput>({

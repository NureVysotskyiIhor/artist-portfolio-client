...
import type {
  FavoriteRequest,
  FavoritePaintingStatsResponse,
  FavoriteResponse,
  FavoriteWithPaintingResponse,
...
export const getFavoritesWithPainting = async () => {
  return await apiRequest<FavoriteWithPaintingResponse[]>(`/favorites/with-painting`);
};

export const getFavoriteStats = async () => {
  return await apiRequest<FavoritePaintingStatsResponse[]>(`/favorites/stats`);
};

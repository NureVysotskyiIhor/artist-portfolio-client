...
import { useCommissionRequestsQuery, useCommissionRequestsNearbyQuery } from '@/queries/commission-request.queries'
...
const CommissionRequestsArtistPage = () => {
  ...
  const { data: nearbyRequests = [], isLoading: isLoadingNearby } = useCommissionRequestsNearbyQuery(
    locationFilter ?? { latitude: 0, longitude: 0, radiusKm: 0 }
  )

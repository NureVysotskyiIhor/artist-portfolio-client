  ...
  return (
    <div className="rounded-2xl border border-border bg-white p-5 shadow-sm flex flex-col gap-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <span className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full shrink-0 ${statusColors[request.status]}`}>
      ...
      <div className="flex items-center justify-between pt-1">
        <p className="text-[10px] text-muted-foreground">
          Updated {new Date(request.updatedAt).toLocaleDateString('en-GB', {
            day: 'numeric', month: 'short', year: 'numeric',
          })}
        </p>
